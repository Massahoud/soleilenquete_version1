...
class FiltersGroupes extends StatelessWidget {
  final int groupCount;

  FiltersGroupes({required this.groupCount});
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              _buildFilterButton(Icons.mode_edit, "Modi"),
              SizedBox(width: 8),
    ...
    return ElevatedButton(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 5),
          Text("Créer un groupes", style: TextStyle(color: Colors.white)),
        ],
      ),
    );
  }
